...
/***/ function(module, exports, __webpack_require__) {
	...
	function Errors() {
	    ...
	    this.hasErrors = function () {
	        return !_lodash2.default.isEmpty(this.errors);
	    };

	    this.has = function (field) {
	        return _lodash2.default.indexOf(_lodash2.default.keys(this.errors), field) > -1;
	    };
	    ...
	    this.flatten = function () {
	        return _lodash2.default.flatten(_lodash2.default.toArray(this.errors));
	    };
